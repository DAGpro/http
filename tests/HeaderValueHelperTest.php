...
final class HeaderValueHelperTest extends TestCase
{
    ...
    public function testGetParameters(
        ...
        if ($lowerCaseValue === null && $lowerCaseParameter === null) {
            $this->assertSame($expected, HeaderValueHelper::getParameters($input));
        } else {
            $this->assertSame($expected, HeaderValueHelper::getParameters($input, $lowerCaseParameter, $lowerCaseValue));
        }
    }
}
